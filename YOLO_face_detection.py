...
class FaceDetector:
    ...
    def run(self):
        ...
        st.subheader(
            "После того как вы загрузите фотографию я посчитаю сколько на ней лиц людей. Эту функцию можно использовать для подсчёта количества людей на фотографии."
        )
        uploaded_file = st.file_uploader(
            "Выберите изображение (jpg, jpeg, png)", type=["jpg", "jpeg", "png"]
        )
