...
show_info = False # Булевая переменная для определения необходимости отображения подробной информации о проекте

models = ['Стартовая страница', 'GPT 3.5_turbo', 'YOLO8_face_detector'] # Список, который передаётся в selectbox (выпадающий список) для обработки того, какую модель запустить
